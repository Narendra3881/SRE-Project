...
resource "aws_subnet" "public_subnet_1a" {
  ...
  tags                    = var.tags_public_subnet_1a
}
...
resource "aws_subnet" "public_subnet_1b" {
  ...
  map_public_ip_on_launch = true
  tags                    = var.tags_public_subnet_1b
}
...
# create private app subnet private-subnet-1a
resource "aws_subnet" "private_subnet_1a" {
  ...
  tags      = var.tags_private_subnet_1a
}

# create private app private-subnet-1b
resource "aws_subnet" "private_subnet_1b" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private_subnet_1b_cidr
  availability_zone        = data.aws_availability_zones.available_zones.names[1]
  map_public_ip_on_launch  = false
  tags                     = var.tags_private_subnet_1b
}
...
# associate rds private subnet 1a to "rds private route table"
resource "aws_route_table_association" "rds_pvt-subnet-1a_route_table_association" {
  subnet_id           = aws_subnet.db_subnet_1a.id
  route_table_id      = aws_route_table.rds_pvt_route_table.id
}

# associate  rds private subnet 1b to "rds private route table"
resource "aws_route_table_association" "rds_pvt-subnet-1b_route_table_association" {
