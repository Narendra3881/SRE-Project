...
output "private_subnet_2a_id" {
  value       = module.vpc.private_subnet_2a_id
...
output "db_subnet_2a_id" {
  value       = module.vpc.db_subnet_2a_id
  description = "The ID of the DB Subnet 2a."
}

output "db_subnet_2b_id" {
  value       = module.vpc.db_subnet_2b_id
  description = "The ID of the DB Subnet 2b."
}
...
# Output for EBS Volume IDs
output "appserver01_volume_id" {
  value       = aws_ebs_volume.appserver01_volume.id
  description = "The ID of the EBS Volume for Appserver 01."
}

output "appserver02_volume_id" {
  value       = aws_ebs_volume.appserver02_volume.id
  description = "The ID of the EBS Volume for Appserver 02."
}
...
output "network_load_balancer_arn" {
  ...
  value       = module.network_load_balancer.network_load_balancer_arn
}

output "network_load_balancer_name" {
  description = "The name of the network load balancer."
  value       = module.network_load_balancer.network_load_balancer_name
}
